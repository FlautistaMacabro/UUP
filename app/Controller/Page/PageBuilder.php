    ...
    //Método responsável por retornar a estrutura da paginação
     public static function getButtons($paginas, $caminho){
      ...
      public static function getItems($list)
      {
       ...
       //Método responsável por os itens da listagem
       public static function getItemsDisciplinas($list)
       {
         $items = '';
         $count = count($list);
         $itemName = '';
         ...
         for ($i=0; $i < $count ; $i++) {
             (!($i%2 == 0)) ? $itemName = '71' : $itemName = '72';

             $items .= PageBuilder::getComponent("pages/items/item{$itemName}", ['item' => $list[$i]->nome, 'id' =>  $list[$i]->id_discAnual]);
         }
       ...
       //Método responsável por os itens da listagem
       public static function getItemsAulas($list)
       {
         $items = '';
         $count = count($list);
         $itemName = '';
         ...
         for ($i=0; $i < $count ; $i++) {
             ...
             $items .= PageBuilder::getComponent("pages/items/item{$itemName}", ['item' => $list[$i]->nome, 'id' =>  $list[$i]->id_aula]);
         }
